...
PURPOSE
  The main header files for the project, Dispatches to the application specific initialization and main 
  functions
  
-------------------------------------------------------------------------------------------------------------- */


#include "general.h"    /* General project specific defintions and standard C library includes */

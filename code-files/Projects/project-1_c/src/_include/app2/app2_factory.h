...
/*	Specific function: startup_app2 – overrides vtbl_startup in base_app_factory_interface 		*/
int startup_app2(struct base_app_factory* basePtr);

/*	Specific function: main_app2 – overrides vtbl_shutdown in base_app_factory_interface 		*/
